...
export const ProjectFour: React.FC = () => {
  return (
    <PageTransition>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }}>
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold text-zinc-900 dark:text-white mb-6 leading-tight">
              HealthVitals Mobile App
            </h1>
            <p className="text-xl text-zinc-700 dark:text-zinc-300 leading-relaxed font-medium mb-8">
              Cross-platform mobile application for tracking patient vitals and medication adherence. Compliant with HIPAA standards.
            </p>
             <div className="flex flex-wrap gap-3 mb-8">
               {['React Native', 'Firebase', 'Redux Toolkit'].map(tech => (
            ...
            <div className="flex gap-4">
              <a href="https://healthvitals.iamadamnelson.com" target="_blank" rel="noopener noreferrer" className="px-6 py-3 bg-primary-600 hover:bg-primary-700 text-white rounded-lg font-bold flex items-center gap-2 transition-all shadow-lg shadow-primary-500/20">
          ...
          <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.8, delay: 0.2 }} className="relative">
             <div className="relative rounded-xl overflow-hidden shadow-2xl border border-zinc-200 dark:border-zinc-800 aspect-video bg-zinc-100 dark:bg-zinc-900">
              <img src="https://picsum.photos/600/400?random=4" alt="Health App" className="w-full h-full object-cover" />
            </div>
          </motion.div>
        </div>
          ...
          <div className="md:col-span-2 space-y-12">
             <section>
              ...
              <div className="prose dark:prose-invert max-w-none text-zinc-700 dark:text-zinc-300 font-medium leading-relaxed">
                <p>Security and usability were paramount for this application. We implemented biometric authentication and secure local storage for offline capabilities.</p>
              </div>
            </section>
          </div>
        </div>
